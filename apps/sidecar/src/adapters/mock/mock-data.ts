    ...
    workspaces: [
      {
        ...
        region: "us-east-1",
        coreMarkdownFiles: ["AGENTS.md", "BOOTSTRAP.md", "IDENTITY.md", "SOUL.md", "TOOLS.md", "USER.md", "HEARTBEAT.md"],
      ...
      },
      {
        ...
        region: "us-west-2",
        coreMarkdownFiles: ["AGENTS.md", "BOOTSTRAP.md", "TOOLS.md", "USER.md"],
      ...
      },
      {
        ...
        region: "eu-central-1",
        coreMarkdownFiles: ["AGENTS.md", "BOOTSTRAP.md", "IDENTITY.md", "SOUL.md", "TOOLS.md", "USER.md"],
      ...
      },
      {
        ...
        region: "us-east-2",
        coreMarkdownFiles: ["AGENTS.md", "BOOTSTRAP.md", "HEARTBEAT.md", "IDENTITY.md", "MEMORY.md", "SOUL.md", "TOOLS.md", "USER.md"],
